...
resource "aws_vpc" "main" {
  # checkov:skip=CKV2_AWS_11:VPC flow logging not required for portfolio demo
  # checkov:skip=CKV2_AWS_12:Default security group restriction not set for portfolio demo
...
resource "aws_subnet" "public" {
  # checkov:skip=CKV_AWS_130:Public IP assignment required for public subnets in EKS
  count = 3
