...
resource "kubernetes_deployment" "sample" {
  # checkov:skip=CKV_K8S_15:imagePullPolicy Always not required for portfolio demo
  # checkov:skip=CKV_K8S_43:Image digest pinning not required for portfolio demo
  # checkov:skip=CKV_K8S_28:NET_RAW capability restriction not set for portfolio demo
  # checkov:skip=CKV_K8S_9:Readiness probe not configured for simple portfolio demo
  # checkov:skip=CKV_K8S_29:Pod security context not configured for portfolio demo
  # checkov:skip=CKV_K8S_30:Container security context not configured for portfolio demo
  # checkov:skip=CKV_K8S_8:Liveness probe not configured for simple portfolio demo
  metadata {
    name      = "sample-nginx"
