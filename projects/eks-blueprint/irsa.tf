...
resource "aws_iam_policy" "lbc" {
  # checkov:skip=CKV_AWS_355:AWS Load Balancer Controller requires broad resource access by design
  # checkov:skip=CKV_AWS_290:AWS Load Balancer Controller requires write access to manage load balancers
